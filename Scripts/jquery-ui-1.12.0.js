...
var dataSpace = "ui-effects-",
	...
	// Save a local jQuery because jQuery Color relies on it and the
...
var effectsEffectExplode = $.effects.define( "explode", "hide", function( options, done ) {
	...
	for ( i = 0; i < rows; i++ ) { // ===>
		...
		for ( j = 0; j < cells; j++ ) { // |||
			...
			// Save a clone of the now hidden main element that will be absolute positioned
...
var labels = $.fn.labels = function() {
	...
	if ( id ) {
		...
		// Save a selector for the label based on the id
		...
		$.each( this.options.items, function( widget, selector ) {
			...
			that.element
				...
				.each( function() {
					...
					// Save the widget if it doesn't exist
					if ( !instance ) {
...
$.ui.ddmanager = {
	...
	drop: function( draggable, event ) {
		...
		// Save a copy of the droppables in case the list changes during the drop (#9116)
